...
const EF2 = () => {
  ...
  return (
    <div ref={ref} id="ef-2" className="scroll-mt-20 max-w-6xl mx-auto p-6 bg-white dark:bg-slate-800 rounded-xl shadow-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Card 1 */}
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center mb-4">
            <FaGraduationCap className="text-4xl text-blue-500 mr-4" />
            <h3 className={`${titleFont.className} text-xl font-bold text-slate-700 dark:text-slate-200`}>Formação Cidadã</h3>
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center mb-4">
            ...
            <h3 className={`${titleFont.className} text-xl font-bold text-slate-700 dark:text-slate-200`}>Conteúdo Aplicável e Conectado</h3>
          </div>
          <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center mb-4">
            ...
            <h3 className={`${titleFont.className} text-xl font-bold text-slate-700 dark:text-slate-200`}>Presente na BNCC</h3>
          </div>
          <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-center mb-4">
            ...
            <h3 className={`${titleFont.className} text-xl font-bold text-slate-700 dark:text-slate-200`}>Foco na Matemática</h3>
          </div>
          <p className="text-gray-600 dark:text-slate-300 leading-relaxed">
