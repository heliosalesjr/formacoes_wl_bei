  ...
  return (
    <div ref={ref} id="mat-2" className="bg-white dark:bg-slate-800 scroll-mt-20 rounded-2xl shadow-2xl overflow-hidden p-6 md:p-10 space-y-10">
          ...
          <div className="md:w-1/3 px-4 md:px-6 pb-6 md:pb-0 flex flex-col items-center text-center md:text-left">
            ...
            <h3 className="text-slate-700 dark:text-slate-200 font-bold text-lg mb-3">Papel do educador</h3>
          ...
          <div className="md:w-1/3 px-4 md:px-6 py-6 md:py-0 flex flex-col items-center text-center md:text-left">
            ...
            <h3 className="text-slate-700 dark:text-slate-200 font-bold text-lg mb-3">Finalidade pedagógica</h3>
            <p className="text-slate-700 dark:text-slate-200 text-sm md:text-base">
          ...
          <div className="md:w-1/3 px-4 md:px-6 pt-6 md:pt-0 flex flex-col items-center text-center md:text-left">
            ...
            <h3 className="text-slate-700 dark:text-slate-200 font-bold text-lg mb-3">Metodologias e estrutura</h3>
            <p className="text-slate-700 dark:text-slate-200 text-sm md:text-base">
          ...
          {/* Seção de Dropdowns */}
          <div className="mt-10">
            <h3 className="text-xl md:text-2xl font-semibold text-center text-slate-800 dark:text-slate-200 mb-6">
