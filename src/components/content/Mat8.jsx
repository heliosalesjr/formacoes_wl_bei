    ...
    <div ref={ref} id="mat-8" className="scroll-mt-20 bg-white dark:bg-slate-800 rounded-lg shadow-2xl p-6 md:p-10 space-y-8 text-center">
      ...
      <div className="text-left max-w-3xl mx-auto">
        <button
          ...
          className="w-full flex justify-between items-center bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors rounded-lg px-6 py-4 shadow border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 font-semibold"
        >
        ...
        {isOpen && (
          <div className="bg-white dark:bg-slate-800 border border-t-0 border-slate-200 dark:border-slate-700 rounded-b-lg px-6 py-4 space-y-4 text-sm text-slate-700 dark:text-slate-200">
            ...
            <p>
              ...
              Disponível em: <a href="https://novaescola.org.br/conteudo/424/14-perguntas-e-respostas-sobre-projetos-didaticos" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">https://novaescola.org.br/conteudo/424/14-perguntas-e-respostas-sobre-projetos-didaticos</a>
            </p>
            <p>
              ...
              Disponível em: <a href="https://novaescola.org.br/conteudo/20407/aprendizagem-baseada-em-projetos-entenda-o-que-e-e-como-funciona-na-pratica" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">https://novaescola.org.br/conteudo/20407/aprendizagem-baseada-em-projetos-entenda-o-que-e-e-como-funciona-na-pratica</a>
            </p>
          </div>
        )}
      </div>
