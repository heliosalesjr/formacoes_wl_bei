...
const Modulo1Objetivos = () => {
  ...
  return (
    <div ref={ref} id="modulo-1-objetivos" className="scroll-mt-20 rounded-xl bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800 p-8 shadow-2xl border border-slate-100 dark:border-slate-700">
      <div className="flex items-center justify-center gap-3 mb-8">
        <h2 className="text-4xl font-bold text-center text-slate-600 dark:text-white py-4">
          Objetivos do Módulo
        </h2>
        </div>
      ...
      <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
        {objetivos.map((obj, index) => (
          ...
          >
            ...
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 mb-3">{obj.title}</h3>
